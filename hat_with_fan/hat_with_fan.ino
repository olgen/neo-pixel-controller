...
#define FAN_LED_PIN     6   // which pin your pixels are connected to
#define NUM_LEDS    93   // how many LEDs you have
#define FAN_NUM_LEDS  36   // how many LEDs you have
...
void setup() {
  ...
  FastLED.addLeds<WS2812B, FAN_LED_PIN, COLOR_ORDER>(fan_leds, FAN_NUM_LEDS).setCorrection( TypicalLEDStrip );
...
void FillLEDsFromPaletteColors( uint8_t colorIndex) {
  ...
  for( int i = 0; i < FAN_NUM_LEDS; i++) {
    fan_leds[i] = ColorFromPalette( currentPalette, colorIndex, BRIGHTNESS, currentBlending);
    colorIndex += STEPS;              
  }
}
